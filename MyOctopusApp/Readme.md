...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *MyOctopusApp*):
...
Execute unit tests
```
    cd "MyOctopusApp/test/MyOctopusApp.Tests"
    dotnet test
```

Deploy application
```
    cd "MyOctopusApp/src/MyOctopusApp"
